...
const Slider = ({ title, pera, src, width, height }) => {
  return (
    <div className="bgImg px-4 w-full h-full flex max-sm:flex-col  items-center justify-center">
      <div className="w-[50%] max-sm:h-[50%] px-6 flex flex-col justify-center max-sm:w-full">
      ...
      <div className="w-[50%] max-sm:h-[50%] overflow-hidden  flex items-center justify-center max-sm:w-full">
        <Image
          src={src}
